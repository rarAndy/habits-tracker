...
export function renderTracker() {
    ...
    <div class="ss-tracker">
      <div class="ss-tracker-head">
        <div style="font-size:11px;font-weight:500;letter-spacing:0.04em;color:var(--text3);margin-bottom:8px">Tracker</div>
        ...
        <p style="font-size:14px;color:var(--text2);margin:0">${globalStreak > 0 ? `${globalStreak}-day streak · ` : ''}${totalHabits} habit${totalHabits !== 1 ? 's' : ''} tracked.</p>
      </div>
